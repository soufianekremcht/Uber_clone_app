...
import com.soufianekre.uberclone.ui.driver.profile.DriverProfileActivity;
...
public class DriverMapActivity extends BaseActivity implements DriverMapMvp.View {
    ...
    SwitchCompat driverIsBusySwitch;
...
//            mMap.moveCamera(CameraUpdateFactory.newLatLng(driverLastLocationLatLng));
    ...
    private void setupUi(){
        ...
        driverIsBusySwitch.setOnCheckedChangeListener((compoundButton, checked) -> {
            if (checked){
