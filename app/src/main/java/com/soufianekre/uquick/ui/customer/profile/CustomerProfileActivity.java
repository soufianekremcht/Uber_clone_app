package com.soufianekre.uquick.ui.customer.profile;
...
import static com.soufianekre.uquick.helpers.FirebaseConstant.PROFILE_IMAGES_PATH;
...
public class CustomerProfileActivity extends BaseActivity {
    ...
    @BindView(R.id.customer_profile_img)
    ...
    private void setupUi(){
        ...
        customerProfileToolbar.setNavigationOnClickListener(v->{
            onBackPressed();
        });
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_arrow_back_white_24dp);

        customerProfileImage.setOnClickListener(view -> {
       ...
       mCustomerRefListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    ...
                    Object name = values.get(CUSTOMER_NAME);
                    Object phone = values.get(CUSTOMER_PHONE);
                    Object profileImageUrl = values.get(CUSTOMER_PROFILE_IMAGE_URL);
